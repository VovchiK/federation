...
struct boss_supremusAI : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        HatefulStrikeTimer = 500000;
        SummonFlameTimer = 200000;
        SwitchTargetTimer = 9000000;
        PhaseSwitchTimer = 6000000;
        SummonVolcanoTimer = 500000;
        BerserkTimer = 9000000;                              // 15 minute enrage
