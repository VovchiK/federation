...
struct boss_hakkarAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if (CheckJeklik_Timer <= diff)
        {
            if (pInstance)
            {
                if (!pInstance->GetData(TYPE_JEKLIK) != 1)
                {
        ...
        if (CheckVenoxis_Timer <= diff)
        {
            if (pInstance)
            {
                if (!pInstance->GetData(TYPE_VENOXIS) != 1)
                {
        ...
        if (CheckMarli_Timer <= diff)
        {
            if (pInstance)
            {
                if (!pInstance->GetData(TYPE_MARLI) != 1)
                {
        ...
        if (CheckThekal_Timer <= diff)
        {
            if (pInstance)
            {
                if (!pInstance->GetData(TYPE_THEKAL) != 1)
                {
        ...
        if (CheckArlokk_Timer <= diff)
        {
            if (pInstance)
            {
                if (!pInstance->GetData(TYPE_ARLOKK) != 1)
                {
